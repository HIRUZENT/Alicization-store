    ...
    <>
      ...
      <div className="container-fluid container-card">
        <div className="row row-card">
          <div data-aos="fade-up" data-aos-duration="400" className="col-md-4 col-lg-3 col-sm-4 col-6 d-flex column-card cards1">
            <a href="/joki/jarlo-six" className="d-flex">
              <img src={herta} alt="Card_2" />
              <h4>JARILO-VI</h4>
            </a>
          </div>
          <div data-aos="fade-up" data-aos-duration="600" className="col-md-4 col-lg-3 col-sm-4 col-6 d-flex column-card cards2">
          ...
          <div data-aos="fade-left" data-aos-duration="1000" className="col-md-4 col-lg-3 col-sm-4 col-6 d-flex column-card cards4">
